...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().amount(DEFAULT_AMOUNT).dateTime(DEFAULT_DATE_TIME).status(DEFAULT_STATUS);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().amount(UPDATED_AMOUNT).dateTime(UPDATED_DATE_TIME).status(UPDATED_STATUS);
        return payment;
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).dateTime(UPDATED_DATE_TIME).status(UPDATED_STATUS);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).dateTime(UPDATED_DATE_TIME).status(UPDATED_STATUS);

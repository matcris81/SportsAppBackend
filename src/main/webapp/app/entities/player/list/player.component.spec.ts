...
describe('Player Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'player', component: PlayerComponent }]), HttpClientTestingModule, PlayerComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.players?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

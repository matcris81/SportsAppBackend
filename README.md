...
To build the final jar and optimize the footy_fix application for production, run:
...
Then navigate to [http://localhost:4242](http://localhost:4242) in your browser.
